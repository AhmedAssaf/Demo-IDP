...
namespace DemoIDP
{
    ...
    {
        public static void EnsureSeedData(string connectionString, string identityConnnection)
        {
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            var alice = userMgr.FindByNameAsync("assaf").Result;
            if (alice == null)
            {
                alice = new IdentityUser
                {
                    UserName = "assaf",
                    Email = "AhmedAssaf@email.com",
                    EmailConfirmed = true,
                };
